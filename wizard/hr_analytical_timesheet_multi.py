...
class analytical_timesheet_employees_multi(osv.osv_memory):
    ...
    _columns = {
        ...
        'public_day_holiday':fields.many2one('hr.holidays.public', 'Public Holiday Calendar Year'),
        'employee_ids':fields.many2many("hr.employee",'emplyee_hr_multis','wizard_id','employee_id','Employees'),
...
#                 }
        return {
                    'type': 'ir.actions.report.xml',
                    'report_name': 'timesheet_report.report_qweb_timesheet_repeat',
                    'datas': datas,
                    'context':context
                }
